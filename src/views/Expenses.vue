...
<div class="col-2 md:col-1 pt-3"><i v-tippy="{ content: 'The items created on this page are actual expenses grouped by expendure items.' }" class="pi pi-question-circle" style="font-size: 1.5rem"></i></div>
</div></div>
