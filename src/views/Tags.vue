...
<div class="col-2 md:col-1 pt-3"><i v-tippy="{ content: 'Tags are designed for grouping and easy filtering for expenses. Each expense may have one ore many tags.' }"  class="pi pi-question-circle" style="font-size: 1.5rem"></i></div>
</div></div>
